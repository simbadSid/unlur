...
public class ColorParameterChooserCustomIdListener implements OnClickListener
{
// ---------------------------
// Attributs
// ---------------------------
...
// Constructeut
// ---------------------------
	public ColorParameterChooserCustomIdListener(ColorParameterCustomChooserActivity act)
	{
		this.act = act;

		String		str;
		Resources	res = act.getResources();
		Button		b	= (Button)act.findViewById(R.id.colorChooserCustomParameterId);

		switch (act.elementId)
		{
...
// ---------------------------
	...
	private class OkListener implements DialogInterface.OnClickListener
	{
		public void onClick(DialogInterface dialog, int which)
		{
			...
			switch(checkedItem)
			{
				case 0:	act.elementId	= GroundView.ELEMENT_FIELD;		break;
				case 1:	act.elementId	= GroundView.ELEMENT_OUTLINE;	break;
				case 2:	act.elementId	= GroundView.ELEMENT_BLACK_PAWN;break;
				case 3:	act.elementId	= GroundView.ELEMENT_WHITE_PAWN;break;
				default:	throw new RuntimeException("Unhandeled elementId");
			}
			act.matchSeekBarToColor();
		}
	}
